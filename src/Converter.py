...
RESOURCE_PATH = "/home/byq/byq/code/geely/xodr-OSM-Converter/resource/"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_file', type=str, default='hangzhouwan.xodr', help='Input OpenDRIVE file name')
    ...
    parser.add_argument('--output_file', type=str, default='hangzhouwan.osm', help='Output OSM file name')
